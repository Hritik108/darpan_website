  ...
  render() {
    return (
      ...
      <ul className="cbp_tmtimeline">
					<li>
						<time className="cbp_tmtime"><span>2016</span></time>
						<div className="cbp_tmicon cbp_tmicon-phone" id="about-icon"></div>
					...
					<li>
						<time className="cbp_tmtime"><span>2018</span></time>
						<div className="cbp_tmicon cbp_tmicon-phone" id="about-icon"></div>
						<div className="cbp_tmlabel">
					...
					<li>
						<time className="cbp_tmtime"><span>2020</span></time>
						<div className="cbp_tmicon cbp_tmicon-phone" id="about-icon" ></div>
						<div className="cbp_tmlabel">
					...
					<li>
						<time className="cbp_tmtime"><span>2022</span></time>
						<div className="cbp_tmicon cbp_tmicon-phone" id="about-icon" ></div>
						<div className="cbp_tmlabel">
